...
# 默认：
#   IN_DIR  = /data00/yinhaolang/simulators/tmp/dataset_3m_pq
#   OUT_DIR = /data00/yinhaolang/simulators/tmp/dataset_3m_dedup_pq
#   CTX_LEN = 128
#
...
IN_DIR="${1:-/data00/yinhaolang/simulators/tmp/dataset_3m_pq}"
OUT_DIR="${2:-/data00/yinhaolang/simulators/tmp/dataset_3m_dedup_pq}"
CTX_LEN="${3:-128}"
