...
OUT=${OUT:-ckpt/v26_kvqr_clean14_smoke}
DEVICE=${DEVICE:-cuda}
...
echo "[v26-kvqr] schema=v26_14 UOP fields, PMU=v26a_8key"
...
echo "[v26-kvqr] clean 14-field schema requires rebuilding windows/cache"
