...
echo "[v26-kvqr-ddp] schema=compat6 UOP fields, PMU=v26a_8key"
...
echo "[v26-kvqr-ddp] clean 10-field schema requires rebuilding windows/cache"
...
exec "$TORCHRUN" \
  ...
  "${flash_args[@]}" \
  2>&1 | tee logs/train_v26_kvqr_compat_ddp8.log
