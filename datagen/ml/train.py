...
def main():
    ...
    log.info('[init] positive rates=%s', pos_rates)
    ...
    try:
        while step < args.steps:
            for batch in loader:
                ...
                mispred_stats = binary_stats_from_logits(
                    out['mispred_logit'].detach(), batch_dev['mispred'])
                head_stats = binary_stats_from_logits(
                    out['head_logit'].detach(), batch_dev['head'])
                ...
                if step % args.log_every == 0 or step == 1:
                    ...
                    log.info(
                        ...
                        'mse_f_pos=%.3f mse_f_cons=%.3f mse_e=%.3f '
                    ...
                    write_status_now({
                        ...
                        'mse_fetch_pos': float(losses['mse_fetch']),
                        'mse_fetch_cons': float(losses['mse_fetch_cons']),
