...
读 [pthread_harness.c](file:///data00/yinhaolang/simulators/taogen/workloads/common/pthread_harness.c)：
...
来源：[3656012.txt](file:///data00/yinhaolang/simulators/taogen/docs/3656012.txt) §5 EVALUATION（Page 14–15）。
